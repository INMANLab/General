...
### IMPLEMENTATION
import pandas as pd
datapath = '/Users/justincampbell/Library/CloudStorage/GoogleDrive-u0815766@gcloud.utah.edu/My Drive/Research Projects/BLAES/Data/BLAESCoords 021523.csv'
BLAESCoords = pd.read_csv(datapath)
xyz = BLAESCoords[['X', 'Y', 'Z']].to_numpy()
dPrime = BLAESCoords['dPrimeDiff_Item'].to_numpy()

if __name__ == "__main__":
    plotBLAESStim(xyz, dPrime) # MNI
